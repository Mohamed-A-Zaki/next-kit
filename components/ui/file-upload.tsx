...
import { File, ImageIcon, Trash2, Upload, X } from "lucide-react";
    ...
    >
      <div className="bg-muted flex items-center justify-between overflow-hidden rounded-lg p-2 sm:p-3">
        <div className="flex min-w-0 flex-1 items-center space-x-2 sm:space-x-3">
          <div
            className={`bg-background flex size-6 flex-shrink-0 items-center justify-center rounded p-1 sm:size-8 sm:p-2`}
          >
